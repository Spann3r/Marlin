...
#define STRING_CONFIG_H_AUTHOR "(spann3r, ender3pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 19.6277
    #define DEFAULT_Ki 1.5208
    #define DEFAULT_Kd 63.3314
  #endif
#endif // PIDTEMP
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38.2, 0, -2.32 }
...
#define X_MIN_POS 0
#define Y_MIN_POS -19.15 //-19.15 For BLV
#define Z_MIN_POS 0
